...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span> Sale List</h2>
</div>
...
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ route('sale.create') }}" class="btn btn-primary" title="Add New Sale"><i
                    class="fa fa-plus"></i>&nbsp;&nbsp;<span class="bold">Add New Sale</span></a>

            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Sale Search</h3>
                </div>
                <div class="panel-body" style="overflow: auto;">
                    <form action="" method="get">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ Request()->sale_title }}"
                                placeholder="Sale Title" name="sale_title">
                        </div>
                        {{-- <div class="col-md-3">
                            <label>Sale Description </label>
                            <input type="text" class="form-control" value="{{ Request()->sale_description }}"
                                placeholder="Sale Description" name="sale_description">
                        </div> --}}
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="{{ url('admin/sale') }}" class="btn btn-success">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="get" action="{{ route('sale.delete', $value->id) }}">
                                        <a href="{{ route('sale.show',$value->id) }}"
                                            class="btn btn-primary btn-rounded btn-sm"><span
                                                class="fa fa-eye"></span></a>
                                        <a href="{{ route('sale.edit',$value->id) }}"
