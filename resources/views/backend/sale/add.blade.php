...
@section('content')
        ...
        <div class="page-title">                    
            <h2><span class="fa fa-arrow-circle-o-left"></span> Add Sale</h2>
        </div>
            ...
            <div class="panel panel-default">
               ...
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     <label class="col-md-2 col-xs-12 control-label">Sale Title  <span style="color:red"> *</span></label>
                     <div class="col-md-8 col-xs-12">
                        <div class="">
                           <input name="sale_title" value="{{ old('sale_title') }}" placeholder="Sale Title" type="text" required class="form-control" />
                  ...
                  <div class="form-group">
                     <label class="col-md-2 col-xs-12 control-label">Sale Description <span style="color:red"> *</span></label>
                     <div class="col-md-8 col-xs-12">
                        <div class="">
                           <input name="sale_description" value="{{ old('sale_description') }}" placeholder="Sale Description" type="text" required class="form-control" />
